 ...
 * GitHub repo fork. Requires the Vercel-GitHub integration to be
 * installed on the user's GitHub account (one-time setup via the
 * Vercel dashboard — already done if the template repo is deployed).
 */
 ...
 *
 * @param token        - EXPO_PUBLIC_VERCEL_TOKEN
 * @param projectName  - Vercel project name (lowercase, hyphens only)
 * @param githubOwner  - GitHub repo owner
 * @param githubRepo   - GitHub repo name
 */
